                    ...
                    <div className="grid gap-4 py-20 text-left md:grid-cols-2">
                        <div className="mb-5">
                            ...
                            <div className="flex flex-row gap-2 mt-4 socials">
                                <Link href="https://github.com/metofz" target="_blank" className="social-media">
                                    <Image src={GithubIcon} alt="Github Icon" width={40}/>
                                </Link>
                                <Link href="https://www.linkedin.com/in/reza-fazriansyah-525544252" target="_blank" className="social-media">
                                    <Image src={LinkedInIcon} alt="LinkedIn Icon" width={40}/>
                                </Link>
                                <Link href="https://www.instagram.com/rezafazriansyah" target="_blank" className="social-media">
